...
int	main(void)
{
	...
	t_test tests[] = {
		...
		},
		{
			...
			.min = 2147483645,
			.max = 2147483647,
			.expected = (int[]){2147483645, 2147483646, -1},
		},
		{
			.desc = "Range near INT_MIN",
			.min = -2147483648,
			.max = -2147483646,
			.expected = (int[]){-2147483648, -2147483647, -1},
		},
		{
		...
		{.desc = "ft_range with min 0, max 0", .min = 0, .max = 0,
			.expected = NULL},
		{.desc = "ft_range with min 0, max 5", .min = 0, .max = 5,
			.expected = (int[]){0, 1, 2, 3, 4}},
		{.desc = "ft_range with min -5, max 5", .min = -5, .max = 5,
			.expected = (int[]){-5, -4, -3, -2, -1, 0, 1, 2, 3, 4}},
		{.desc = "ft_range with min -10, max -5", .min = -10, .max = -5,
			.expected = (int[]){-10, -9, -8, -7, -6}},
		{.desc = "ft_range with min 5, max 0", .min = 5, .max = 0,
			.expected = NULL},
	};
